...
def run():
    ...
    img = Image.open('E:/resume/Smart_Resume_Analyser_App-master/Logo/SRA_Logo.png')
    ...
    if choice == 'Normal User':
        st.markdown('''<h4 style='text-align: left; color: #d73b5c;'>* Upload your resume."</h4>''',
